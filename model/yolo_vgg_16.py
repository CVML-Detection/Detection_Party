...
from util.anchor import make_center_anchors
...
class YOLO_VGG_16(nn.Module):
    def __init__(self, vgg=vgg16_bn(pretrained=True), num_classes=20):
        ...
        self.center_anchors = make_center_anchors(self.anchor_whs)
        self.num_anchors = len(self.anchor_whs)
    ...
    def forward(self, x):
        ...
        x = x.permute(0, 2, 3, 1)               # torch.Size([B, 13, 13, 125])
