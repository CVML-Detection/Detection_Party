...
from anchor.anchor import SSD_Anchor, YOLO_Anchor, RETINA_Anchor
...
class Retina_Coder(Coder):
    def __init__(self, data_type):
        super().__init__()
        self.data_type = data_type
        self.center_anchor = RETINA_Anchor('retina').create_anchors(img_size=600).to(device)
