...
class CoCoDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image, boxes, labels = transform_COCO(image, boxes, labels, self.split, new_size=416)
...
if __name__ == '__main__':
    ...
    # coco_dataset = CoCoDataset(root="/home/cvmlserver3/Sungmin/data/COCO", set_name='valminusminival2014', split='TRAIN')
    coco_dataset = CoCoDataset(root="/data/coco", set_name='valminusminival2014', split='TRAIN')
    # coco_dataset = CoCoDataset(root="/data/coco", set_name='minival2014', split='TEST')
