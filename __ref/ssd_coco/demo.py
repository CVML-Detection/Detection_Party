...
def image_transforms(img):
    ...
    transform = tfs.Compose([tfs.Resize((300, 300)),
                             tfs.ToTensor(),
...
if __name__ == '__main__':
    ...
    if demo_opts.data_type == 'voc':
        demo_opts.n_classes = 21

    elif demo_opts.data_type == 'coco':
        demo_opts.n_classes = 81

    model = SSD(VGG(pretrained=True), n_classes=demo_opts.n_classes)
    ...
    coder = SSD_Coder(demo_opts.data_type)
