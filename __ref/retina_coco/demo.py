...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_file_name', type=str, default='retina_res_50_voc')
    ...
    model = RetinaNet(base=Resnet_50(pretrained=True), num_classes=demo_opts.num_classes)
    ...
    coder = RETINA_Coder(demo_opts.data_type)
