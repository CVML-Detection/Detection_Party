...
from dataset.trasform import transform_for_retina as transform    # for retinanet
...
if __name__ == '__main__':
    coco_dataset = COCO_Dataset(root="D:/data/coco", set_name='train2017', split='train', download=True, resize=600)
