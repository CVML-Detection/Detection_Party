...
class YOLO_Anchor(Anchor):
    def create_anchors(self, anchor_whs=[(1.3221, 1.73145), (3.19275, 4.00944), (5.05587, 8.09892), (9.47112, 4.84053), (11.2364, 10.0071)], grid_size=13):
        """
        ...
        center_anchors = center_anchors.view(13 * 13 * 5, 4)  # [845, 4]  0 ~ 13
...
class RETINA_Anchor(Anchor):
    def create_anchors(self, img_size=600):
        ...
        center_anchors.clamp_(0, 1)                       # (67995, 4) 0 ~ 1
